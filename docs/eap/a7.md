...
##################################################################################################################################
  ...
  /api/login:
    post:
      operationId: R206
      summary: 'R206: Login Action'
      description: 'Processes the login. Access: PUB'
      tags:
        - 'M02: Authentication'
      requestBody:
        required: true
      ...
      responses:
        '200':
          description: 'OK, after processing the login.'
          content:
            application/json:
              schema:
                type: object
  ...
  /api/signup:
    post:
      operationId: R208
      summary: 'R208: Signup Action'
      description: 'Processes the new user signup. Access: PUB'
      tags:
        - 'M02: Authentication'
      ...
      responses:
        '200':
          description: 'OK, after processing the signup.'
          content:
            application/json:
              schema:
                type: object
