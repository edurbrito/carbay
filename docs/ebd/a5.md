...
|         R13        | notification(<ins>id</ins>, text **NN**, viewed **NN** **DF** False, dateHour **NN** **DF** Now **CK** dateHour <= Now, contextAuctionID -> Auction, contextRatingID -> Rating, contextHelpMessageID -> helpMessage, contextRegisteredID -> "user", contextBidID -> bid, contextCommentID -> comment, recipientID -> "user" **NN**)|
...
|           **Keys**             |                         {id}                     |
| **Functional Dependencies**    |                                                  |
|           FD81                 | {id} -> {title, startingPrice, startDate, finalDate, suspend, buyNow, scaleType, brandID, colourID, sellerID} |
|       **NORMAL FORM**          |                         BCNF                     |
...
|           **Keys**             |                       {id}                       |
|  **Functional Dependencies**   |                                                  |
|          FD141                 | {id} -> {viewed, date, contextAuctionID, contextRatingID, contextHelpMessageID, contextRegisteredID, contextBidID, contextCommentID, recipientID} |
|       **NORMAL FORM**          |                       BCNF                       |  