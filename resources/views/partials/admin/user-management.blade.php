<li class="list-group-item d-flex align-items-center justify-content-start rounded-0 flex-vertical">
    ...
    <div class="btn-group ml-sm-auto" role="group" aria-label="User Management Buttons">
        ...
        @endif
        <button type="button" data-username="{{ $user->username }}" data-name="{{ $user->name }}" class="btn btn-secondary make-admin-button" data-bs-toggle="modal" data-bs-target="#make-admin" role="button">Make Admin</button>
    </div>
</li>