...
<div class="d-flex my-5 flex-shrink-1 flex-column">
<style scoped>
@media (min-width: 600px) {
    ...
    <div class="card w-auto align-self-start my-3 limited-width">
        <div class="card-body">
    ...
    <div class="card w-auto align-self-end my-3 limited-width">
        <div class="card-body">
            <blockquote class="blockquote mb-0 text-dark">
