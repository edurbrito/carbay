        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="navbar-nav d-flex justify-content-end align-items-center w-100">
                    ...
                    <li class="nav-item navbar-brand mr-0 mr-lg-4"><a href="/login.php" class="text-decoration-none text-reset">Log In</a></li>
                    <li class="nav-item navbar-brand mr-0 mr-lg-4"><a href="/signup.php" class="text-decoration-none text-reset">Sign Up</a></li>
                </ul>
            </div>
        </div>
    </nav>
