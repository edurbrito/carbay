        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav d-flex justify-content-end align-items-center w-100">
                    ...
                    <li class="nav-item navbar-brand mr-0 mr-lg-4 scale-objects"><a href="/admin.php" class="text-decoration-none text-reset"><i class="fas fa-user-shield"></i><span class="d-lg-none .d-xl-block"> Admin Panel</span></a></li>
                    ...
                    <li class="nav-item navbar-brand mr-0 mr-lg-4 scale-objects-sm"><a href="/profile.php" class="text-decoration-none text-reset"><i class="fas fa-user-circle"></i> Admin1</a></li>
