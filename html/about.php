...
<section class="team-section text-center">
  ...
  <div class="row text-center">
    ...
    <div class="col-md-6 mt-4 mt-sm-0">
      ...
      <h4 class="font-weight-bold dark-grey-text my-4 text-light">Eduardo Brito</h4>
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-map-marker-alt mr-3"></i><strong>Montalegre</strong></h6>
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-envelope mr-3"></i><strong>up201806271@fe.up.pt</strong></h6>
      <a type="button" class="btn-floating btn-sm mx-1 mb-0 btn-git text-light" href="https://github.com/edurbrito">
    ...
    <div class="col-md-6 mt-4 mt-sm-0">
      ...
      <h4 class="font-weight-bold dark-grey-text my-4 text-light">Paulo Ribeiro</h4>
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-map-marker-alt mr-3"></i><strong>Póvoa de Varzim</strong></h6>
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-envelope mr-3"></i><strong>up201806505@fe.up.pt</strong></h6>
      <a type="button" class="btn-floating btn-sm mx-1 mb-0 btn-git text-light" href="https://github.com/PJscp16">
        <i class="fab fa-2x fa-github"></i>
      </a>
    </div>
    <!-- Grid column -->
  ...
  <div class="row text-center mt-md-5">
    ...
    <div class="col-md-6 mt-4 mt-sm-0">
      ...
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-map-marker-alt mr-3"></i><strong>Póvoa de Varzim</strong></h6>
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-envelope mr-3"></i><strong>up201806506@fe.up.pt</strong></h6>
      <a type="button" class="btn-floating btn-sm mx-1 mb-0 btn-git text-light" href="https://github.com/pdff2000">
        <i class="fab fa-2x fa-github"></i>
      </a>
    </div>
    <!-- Grid column -->
    ...
    <div class="col-md-6 mt-4 mt-sm-0">
      ...
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-map-marker-alt mr-3"></i><strong>Póvoa de Varzim</strong></h6>
      <h6 class="text-uppercase grey-text mb-3 text-light"><i class="fas fa-envelope mr-3"></i><strong>up201809694@fe.up.pt</strong></h6>
      <a type="button" class="btn-floating btn-sm mx-1 mb-0 btn-git text-light" href="https://github.com/pedrovponte">
        <i class="fab fa-2x fa-github"></i>
      </a>
    </div>
    <!-- Grid column -->
